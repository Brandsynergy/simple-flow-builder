...
if (parsedResponse.actions && (parsedResponse.actions[0].action?.toLowerCase().includes('remind') || parsedResponse.actions[0].reminder)) {
    const reminderDetails = {
    about: parsedResponse.actions[0].parameters?.text || parsedResponse.actions[0].details?.title || parsedResponse.actions[0].details || parsedResponse.actions[0].value || parsedResponse.actions[0].detail || parsedResponse.actions[0].content || parsedResponse.actions[0].subject || parsedResponse.actions[0].message || parsedResponse.actions[0].eventType || 'reminder',
